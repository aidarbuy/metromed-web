			...
			<section>
				<Card>
					<CardActions style={{textAlign:'center'}}>
						<RaisedButton secondary={true} label="Turn On" id="btn_getUserMedia" onTouchTap={getUserMedia_click} />
						<RaisedButton secondary={true} label="Call" 	id="btn_createOffer"  onTouchTap={createOffer_click} />
					...
					<CardMedia>
						<video id="remoteVideo" autoPlay poster={POSTER2} style={{width:'100%'}}>{BROWSER_MESSAGE}</video>
